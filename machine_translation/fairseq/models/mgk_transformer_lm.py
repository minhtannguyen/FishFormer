...
from fairseq.models.mgk_transformer import (
    DEFAULT_MIN_PARAMS_TO_WRAP, Embedding, MGKTransformerDecoder
)
...
@dataclass
class MGKTransformerLanguageModelConfig(FairseqDataclass):
...
@register_model("mgk_transformer_lm", dataclass=MGKTransformerLanguageModelConfig)
class MGKTransformerLanguageModel(FairseqLanguageModel):
    @classmethod
    def hub_models(cls):
...
def mgk_base_lm_architecture(args):
...
@register_model_architecture("mgk_transformer_lm", "mgk_transformer_lm_big")
def mgk_transformer_lm_big(args):
    ...
    mgk_base_lm_architecture(args)


@register_model_architecture("mgk_transformer_lm", "mgk_transformer_lm_wiki103_4head")
@register_model_architecture("mgk_transformer_lm", "mgk_transformer_lm_baevski_wiki103_4head")
def mgk_transformer_lm_baevski_wiki103(args):
    ...
    mgk_transformer_lm_big(args)


@register_model_architecture("mgk_transformer_lm", "mgk_transformer_lm_gbw")
@register_model_architecture("mgk_transformer_lm", "mgk_transformer_lm_baevski_gbw")
def mgk_transformer_lm_baevski_gbw(args):
    args.decoder_embed_dim = safe_getattr(args, "decoder_embed_dim", 512)
    args.dropout = safe_getattr(args, "dropout", 0.1)
    args.attention_dropout = safe_getattr(args, "attention_dropout", 0.1)
    args.no_decoder_final_norm = safe_getattr(args, "no_decoder_final_norm", True)
