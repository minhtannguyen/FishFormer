...
from fairseq.models.smgk_transformer import (
    DEFAULT_MIN_PARAMS_TO_WRAP, Embedding, SMGKTransformerDecoder
)
...
@dataclass
class SMGKTransformerLanguageModelConfig(FairseqDataclass):
...
@register_model("smgk_transformer_lm", dataclass=SMGKTransformerLanguageModelConfig)
class SMGKTransformerLanguageModel(FairseqLanguageModel):
    @classmethod
    def hub_models(cls):
    ...
    def build_model(cls, args, task):
        ...
        decoder = SMGKTransformerDecoder(
...
def smgk_base_lm_architecture(args):
...
@register_model_architecture("smgk_transformer_lm", "smgk_transformer_lm_big")
def smgk_transformer_lm_big(args):
    ...
    smgk_base_lm_architecture(args)


@register_model_architecture("smgk_transformer_lm", "smgk_transformer_lm_wiki103_4head")
@register_model_architecture("smgk_transformer_lm", "smgk_transformer_lm_baevski_wiki103_4head")
def smgk_transformer_lm_baevski_wiki103(args):
    args.decoder_layers = safe_getattr(args, "decoder_layers", 16)
    args.decoder_attention_heads = safe_getattr(args, "decoder_attention_heads", 8//2)
    ...
    smgk_transformer_lm_big(args)


@register_model_architecture("smgk_transformer_lm", "smgk_transformer_lm_gbw")
@register_model_architecture("smgk_transformer_lm", "smgk_transformer_lm_baevski_gbw")
def smgk_transformer_lm_baevski_gbw(args):
    args.decoder_embed_dim = safe_getattr(args, "decoder_embed_dim", 512)
    args.dropout = safe_getattr(args, "dropout", 0.1)
    args.attention_dropout = safe_getattr(args, "attention_dropout", 0.1)
    args.no_decoder_final_norm = safe_getattr(args, "no_decoder_final_norm", True)
