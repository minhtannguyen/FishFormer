...
from fairseq.modules import LayerNorm, MGKAttention
...
class MGKTransformerEncoderLayerBase(nn.Module):
...
class MGKTransformerEncoderLayer(MGKTransformerEncoderLayerBase):
    def __init__(self, args):
        super().__init__(MGKTransformerConfig.from_namespace(args))
        self.args = args

    def build_self_attention(self, embed_dim, args):
        return super().build_self_attention(
            embed_dim, MGKTransformerConfig.from_namespace(args)
        )


class MGKTransformerDecoderLayerBase(nn.Module):
    """Decoder layer block.
...
# backward compatible with the legacy argparse format
class MGKTransformerDecoderLayer(MGKTransformerDecoderLayerBase):
    def __init__(
        self, args, no_encoder_attn=False, add_bias_kv=False, add_zero_attn=False
    ):
        super().__init__(
            MGKTransformerConfig.from_namespace(args),
